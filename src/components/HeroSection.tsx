...
const HeroSection = ({ onNavigate, onLearnMore }) => {
  const handleCartClick = () => {
    window.open("https://shop.natlife.org.in/", "_blank");
  };
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.button
        ...
        className="absolute top-8 right-8 z-20 flex items-center justify-center w-12 h-12 transition-all duration-300 group"
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          ...
          >
            Your premium wellness marketplace for freeze-dried superfoods,
            Ayurvedic remedies, and organic care essentials
          </motion.p>
